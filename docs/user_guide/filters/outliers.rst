...
There is the option to run the outlier filter on the GPU if :code:`cupy` is installed and working on your system. For more information see :doc:`./gpu_mode.rst`.
