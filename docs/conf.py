...
latex_documents = [
    (root_doc, 'MantidImaging.tex', 'MantidImaging Documentation', author, 'manual'),
]
...
man_pages = [(root_doc, 'mantidimaging', 'MantidImaging Documentation', [author], 1)]
...
texinfo_documents = [
    (root_doc, 'MantidImaging', 'MantidImaging Documentation', author, 'MantidImaging',
