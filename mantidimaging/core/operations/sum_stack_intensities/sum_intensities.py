...
class SumIntensitiesFilter(BaseFilter):
   ...
   - Projection angles are not required. If present, projections are sorted into
     angle order on load (see :func:`loader.load
     <mantidimaging.core.io.loader.loader.load>`). If matched angles between stacks
     to be summed together differ, a warning is raised.
