...
class RescaleTest(unittest.TestCase):
    ...
    @parameterized.expand([255.0, 65535.0, 2147483647.0])
    def test_rescale(self, value):
    ...
    def test_execute_wrapper_no_preset(self):
        min_input_value = 12
        max_input_value = 34
    ...
    def test_execute_wrapper_with_preset(self, type: str, expected_max: float):
        min_input_value = 12
        max_input_value = 34
    ...
    def test_scale_single_image(self):
    ...
    def test_scale_single_image_bad_offset(self):
        images = th.generate_images((2, 100, 100))
        try:
    ...
    @parameterized.expand([255.0, 65535.0, 2147483647.0])
    def test_rescale_ignores_nans(self, value):
        images = th.generate_images((10, 100, 100))
