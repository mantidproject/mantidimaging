...
class ShutterCount:
    """
    Class to handle the shutter counts
    """
    ...
    def pulse_per_shutter_range_numbers(self) -> np.array:
        return np.array(self.get_column(ShutterCountColumn.SHUTTER_COUNT), dtype=np.uint32)
