...
class BackgroundCorrectionTest(unittest.TestCase):
    ...
    def do_real_result(self):
        ...
        result = BackgroundCorrectionFilter.filter_func(sample, flat, dark, clip_max=20)
    ...
    def test_clip_max_works(self):
        ...
        result = BackgroundCorrectionFilter.filter_func(sample, flat, dark, clip_max=3)
    ...
    def test_clip_min_works(self):
        ...
        result = BackgroundCorrectionFilter.filter_func(sample, flat, dark, clip_min=300)
