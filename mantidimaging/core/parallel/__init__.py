...
from mantidimaging.core.parallel import exclusive_mem, shared_mem, two_shared_mem, utility  # noqa: F401
...
if sys.platform != 'win32':
    # TODO determine if this can be removed as Python 3.7 is now used!
    import mmap
