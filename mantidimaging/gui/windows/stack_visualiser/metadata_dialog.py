...
from PyQt6.QtWidgets import QWidget, QTreeWidget, QTreeWidgetItem, QDialogButtonBox, QVBoxLayout, QPushButton
from PyQt6.QtGui import QKeySequence, QGuiApplication, QShortcut
