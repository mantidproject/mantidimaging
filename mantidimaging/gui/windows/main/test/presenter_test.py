...
class MainWindowPresenterTest(unittest.TestCase):
    ...
    def test_create_new_stack_images(self):
        ...
        images = generate_images()
        self.presenter.create_dataset_stack_windows(images)
    ...
    def test_create_new_stack_images_focuses_newest_tab(self, mock_QApp):
        ...
        self.view.model_changed.emit = mock.Mock()
        self.presenter.create_dataset_stack_windows(first_images)
        self.assertEqual(1, len(self.presenter.stacks))
        self.view.model_changed.emit.assert_called_once()

        self.presenter.create_dataset_stack_windows(second_images)
    ...
    def test_create_new_stack_with_180_in_sample(self):
        ...
        self.presenter.create_dataset_stack_windows(self.dataset)
    ...
    def test_nexus_load_success_calls_show_information(self):
        ...
        self.presenter.create_dataset_stack_windows = mock.Mock()
        self.presenter.load_nexus_file()
        self.presenter.create_dataset_stack_windows.assert_called_once_with(self.dataset)
