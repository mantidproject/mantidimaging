...
from mantidimaging.gui.windows.spectrum_viewer.fitting_form import FittingFormWidgetView
...
class SpectrumViewerWindowPresenterTest(unittest.TestCase):
    ...
    def test_WHEN_roi_changed_via_spinboxes_THEN_roi_adjusted(self, mock_get_stack_length, mock_get_spectrum):
        ...
        mock_get_stack_length.return_value = 10
