...
class GifParametersWidget(QDialog):
    ...
    def _build_ui(self, optimal_skip: int) -> None:
        ...
        self._update_size_estimate(optimal_skip)
    ...
    def _update_size_estimate(self, value: int) -> None:
        """
        Update the estimated GIF size based on frame skip value.
        ...
        @param value: Frame skip value (e.g. 2 = show every 2nd frame)
        """
        total_frames = self.image_stack.num_projections
        selected_frames = total_frames // value
