...
from mantidimaging.gui.dialogs.cor_inspection.recon_slice_view import ReconSlicesView
...
class CORInspectionDialogViewPyqt(BaseDialogView):
    ...
    def __init__(self, parent, data, slice_index, initial_cor, initial_step=50):
        ...
        self.image_canvas = ReconSlicesView(self)
